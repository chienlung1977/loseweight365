 ...
 */
public class FragmentPlanAverageAll extends Fragment {


    public FragmentPlanAverageAll() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myview = inflater.inflate(R.layout.fragment_plan_average_all, container,false);
